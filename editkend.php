...
<!-- Wrapper -->
	<div id="wrapper">
		...
		<div id="main">
			...
			<!-- Header -->
				<header id="header">
					<a href="#" class="logo"><strong>Edit Vehicle</strong></a>
					<ul class="icons">
				...
				<section>
					...
					<?php 
						$id = $_GET['id'];
						$edit = mysqli_query($koneksi, "SELECT * FROM kendaraan WHERE id_kend = '$id'");
						$data = mysqli_fetch_assoc($edit);
		 			?>
		 			<input type="hidden" name="id" value="<?= $data['id_kend'] ?>">
					<!-- form -->
					<form method="post" action="editkenddb2.php" class="container-form" enctype="multipart/form-data">
						<div class="row gtr-uniform">
							<input type="hidden" name="id" value="<?= $data['id_kend'] ?>">
							<div class="col-6 col-12-xsmall">
								<label>Merk</label>
								<input type="text" name="Merk" id="Merk" value="<?= $data['Merk'] ?>" placeholder="Merek" required>
							</div>
							<div class="col-6">
							...
							<div class="col-6 col-12-xsmall">
								...
								<input type="text" name="no_polisi" id="no_polisi" value="<?= $data['no_polisi'] ?>" placeholder="No Polisi(Plat)">
							</div>
							<div class="col-6">
							</div>
							<div class="col-6">
								<label>Harga Sewa</label>
								<input type="text" name="harga_sewa" id="harga_sewa" value="<?= $data['harga_sewa'] ?>" placeholder="Harga Sewa">
							</div>
							<div class="col-6"></div>
							<div class="col-6">
								<label>Tipe Kendaraan</label>
								<input type="text" name="tipe_kend" value="<?= $data['tipe_kend'] ?>" class="form-control" placeholder="Mobil/Motor" lowercase>
							</div>
							<div class="col-6"></div>
							<div class="col-12-xsmall">
								...
								<?php 
								if ($data['foto'] == "") { ?>
									<img src="<?= $data['foto']; ?>" style="width:100px;height:100px;">
								<?php }else{ ?>
									<img src="<?= $data['foto']; ?>" style="height:100px;">
								<?php } ?>
							</div>
							<div class="col-12 col-12-small">
								<ul class="actions stacked">
									...
									<li>
										<a href="manage.php" class="button">Kembali</a>
									</li>
								</ul>
							</div>
						</div>
