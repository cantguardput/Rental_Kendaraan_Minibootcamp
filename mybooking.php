...
<!-- Wrapper -->
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				<header id="header">
					<a href="#" class="logo"><strong>Your Booking</strong></a>
					<ul class="icons">
				...
				<h3>Hope Your Enjoy Our Services</h3>
				<div class="table-wrapper">
					<table>
						...
						<?php
							$no = 1; 
							$id_user = $_SESSION['id_user'];
							$book = mysqli_query($koneksi, "SELECT * FROM booking WHERE id_user = '$id_user'");
						...
						<tbody>
							...
							<?php } ?>
						<?php }else{?>
							<h2 class="text-center">Kamu Belum Pernah Rental Kendaraan disini :(</h2>
							<p class="text-center"> Silahkan Booking  </p>
						<?php } ?>
						</tbody>
					</table>
				</div>
